...
$sql2 = "SELECT @ROWNUM := @ROWNUM + 1 AS rn, E.* from customer E, (SELECT @ROWNUM := 0 ) TMP ORDER BY write_date DESC limit $start_num, $list";
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col mb-4">
                                <button type="button" id="searchBtn" name="searchBtn" class="btn btn-success">검색</button>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                ?>
                                    ...
                                    ?>
                                        <tbody>
                                            <tr onClick="location.href='insert.php?id=<?= $row['idx'] ?>'" style="cursor:pointer">
                                                <th><?= $row['name'] ?></th>
